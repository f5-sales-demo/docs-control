...
DOCS_SOCKETLESS_ROUTE_EXPRESSION = (
    "${{ github.repository == 'f5-sales-demo/docs-icons' && "
...
def canonical_route_label(value, repository):
    ...
    if value == DOCS_SOCKETLESS_ROUTE_EXPRESSION:
        return "docs-socketless" if repository == DOCS_ICONS_REPOSITORY else "managed-socketless"
