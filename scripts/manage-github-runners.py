...
Directory structure:
  /home/robin/actions-runners/f5-sales-demo/<repo-name>
  /home/robin/actions-runners/f5-sales-demo/.cache
...
DEFAULT_USER = "robin"
DOCS_CONTROL_GOVERNANCE_PATH = Path("/home/robin/GIT/f5-sales-demo/docs-control/.claude/governance.json")
...
def health_check(org, base_dir: Path, gov_path: Path = DOCS_CONTROL_GOVERNANCE_PATH):
    ...
    summary = {"online": 0, "offline": 0, "unregistered": 0, "error": 0}
    ...
    print(f"\nSummary: {summary['online']} Online | {summary['offline']} Offline | {summary['unregistered']} Unregistered | {summary['error']} Errors")
