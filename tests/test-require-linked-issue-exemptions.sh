...
grep -Fq "'{schema_version: 2, source_commit: \$source_commit, files: \$files, absent_paths: \$absent_paths, state_digest: \$state_digest}'" "$publisher"
grep -Fq 'STATE_DIGEST="sha256:' "$publisher"
grep -Fq 'CURRENT_STATE="schema-replacement-required"' "$publisher"
