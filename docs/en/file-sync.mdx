...
restored by reconciliation. Run `python3 scripts/audit-dependency-automation.py` to fail closed on
retired files, mutable Dependabot settings, bot pull requests or branches, catalog drift, and
