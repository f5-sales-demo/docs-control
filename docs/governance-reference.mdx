...
| `.github/workflows/require-linked-issue.yml` | Caller workflow for the linked-issue PR check (docs-control's own caller) |
| `.github/workflows/reusable-require-linked-issue.yml` | Reusable PR check requiring a linked GitHub issue |
...
| `workflows/require-linked-issue.yml` | `.github/workflows/reusable-require-linked-issue.yml` | `pull_request_target` (opened, edited, reopened, synchronize) |
