...
`Configure Antigravity Controls` वर्कफ़्लो उन संगठन चर को बदलता है जो
Antigravity समीक्षक और अनुवादक को नियंत्रित करते हैं। प्रत्येक चरण को पुनः चलाना सुरक्षित है:
...
वर्कफ़्लो मौजूदा शासन व्यक्तिगत पहुंच टोकन, सीमित GitHub API पुनः प्रयासों और
संरचित प्रगति दिल की धड़कनों का उपयोग करता है। इसके लिए GitHub ऐप या GitHub एंटरप्राइज़ सुविधाओं की आवश्यकता नहीं है।
